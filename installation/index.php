...
<head>
    ...
    <?php $themelist = [];
    foreach (glob(__DIR__ . '/../resources/themes/*.css') as $thm) {
        preg_match('/([^\/]*)\.css$/', $thm, $vl);
        $themelist[] = $vl[1];
    }
                ...
                <div class="card border-0 shadow">
                    <div class="card-header bg-primary text-white">
                        <div class="row mx-2 align-items-center">
                            <h5 class="mb-0"><i class="fas fa-wrench"></i> <?php echo L::instl_title; ?> <small
                                        style="font-size: 60%;">v.<?php echo $_GET['v']; ?></small></h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="installation-form">
                            <input id="release-version" name="release-version" type="text"
                                   value="<?php echo $_GET['v']; ?>" style="display: none;"/>
                            <div class="row">
                                <div class="col-lg-12 mb-lg-0">
                                    <div id="alert" class="alert alert-danger" style="display: none;"><i
                                                class="fas fa-exclamation-circle"></i>
                                        <span><?php echo L::gnrl_error; ?></span></div>
                                </div>
                                <div class="col-lg-5 pr-lg-1 mb-lg-0 mb-3">
                                    <div class="card border-0 shadow">
                                        <h6 class="card-header bg-info text-white"><i
                                                    class="fas fa-check"></i> <?php echo L::instl_optns; ?></h6>
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input id="am-activation" class="custom-control-input"
                                                           type="checkbox" name="am-activation">
                                                    <label class="custom-control-label"
                                                           for="am-activation"><?php echo L::instl_am1; ?></label>
                                                    <small class="form-text text-muted"><?php echo L::instl_am2; ?></small>
                                                </div>
                                            </div>
                                            <div id="as-activation-form" class="form-group" style="display: none;">
                                                <div class="custom-control custom-checkbox">
                                                    <input id="as-activation" class="custom-control-input"
                                                           type="checkbox" name="as-activation">
                                                    <label class="custom-control-label"
                                                           for="as-activation"><?php echo L::instl_al1; ?></label>
                                ...
                                <div class="col-lg-7">
                                    <div class="card border-0 shadow">
                                        <h6 class="card-header bg-info text-white"><i
                                                    class="fas fa-file-upload"></i> <?php echo L::instl_ldcnf; ?></h6>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label><?php echo L::instl_srcnf; ?></label>
                                                <div class="custom-file">
                                                    <input id="sr-config-input" class="custom-file-input" type="file"
                                                           accept=".yml" name="sr-config">
                                            ...
                                            <div id="am-config-form" class="form-group" style="display: none;">
                                                ...
                                                <div class="custom-file">
                                                    <input id="am-config-input" class="custom-file-input" type="file"
                                                           accept=".yml" name="am-config">
                                                    <label class="custom-file-label text-truncate"><?php echo L::instl_cnfch; ?></label>
                                                </div>
                                            </div>
                                            <button class="btn btn-success w-100" type="submit"><i
                                                        class="fas fa-cog"></i> <?php echo L::instl_finish; ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
